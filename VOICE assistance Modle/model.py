...
warnings.filterwarnings("ignore" , message= r"torch.utils._pytree.register_pytree_node is deprecatd")
...
OPENAI_KEY = "sk-proj-MYUxxSzna1ZLTPfql4bQT3BlbkFJmJLumgr70Irm4G0L3TRr"
...
def listen_for_wake_word(audio):
    ...
    if wake_word in text_input.lower().strip():
        print('Wake word detected. Please speak your promt to Gemini. ')

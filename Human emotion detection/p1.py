...
def detect_and_display_emotions(frame):
    ...
    if len(faces) > 1:
        ...
        cv2.putText(frame, 'Warning: Multiple Faces Detected!', (10, frame.shape[0] - 10), 
    ...
    for (x, y, w, h) in faces:
        ...
        if emotion_results:
            ...
            if dominant_emotion in ['happy', 'neutral']:
                ...
                confidence_text = 'Under Confidence'
            
            # Display the confidence level instead of the emotion
            cv2.putText(frame, confidence_text, (x, y - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0, 255, 255), 2, cv2.LINE_AA)
